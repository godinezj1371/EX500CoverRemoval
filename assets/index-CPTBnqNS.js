...
BVU: loosen four 2mm screws to remove.`};function wl(e,t,n,r,i,a,o,s){let c=new Jr(new ui(a,o,s),new Si({color:i}));return c.position.set(t,n,r),c.userData.id=e,c.userData.displayName=Sl[e],c.userData.defaultColor=i,c.userData.originalPosition=c.position.clone(),ml.add(c),xl.push(c),c}wl(`A`,1.675,-.5,-1.55,1004218,.85,4.1,2),wl(`B`,1.675,-.5,.55,1004218,.85,4.1,2),wl(`C`,2,-.5,2.1,13882323,.25,4.15,1),wl(`D`,1.25,1.275,-2.025,1004218,1.5,.5,1),wl(`E`,.825,-.5,-1.55,1004218,.85,4.1,2),wl(`F`,.825,-.5,.55,1004218,.85,4.1,2),wl(`G`,.5,-.5,2.1,13882323,.25,4.15,1),wl(`H`,1.25,1.475,0,13882323,1.4,.25,3.2),wl(`I`,1.25,1.475,2.1,13882323,1.25,.25,1),wl(`J`,1.25,-.475,2.5,13882323,1.4,3.75,.1),wl(`K`,1.25,-1,2.6,13882323,.25,2,.1),wl(`L`,-.85,1.15,1.75,1004218,2.5,.9,1.6),wl(`M`,-1.375,1.4,2.2,13882323,.75,1,1),wl(`N`,-1.375,.9,2.525,1004218,.65,.5,.25),wl(`O`,-1.425,.6,1.75,1004218,1.25,.25,1.55),wl(`P`,-.15,.6,1.75,1004218,1.25,.25,1.55),wl(`Q`,1.25,-1,-2.575,1004218,.75,2,.25),wl(`R`,.25,.6,.75,1004218,.5,.25,.5),wl(`S`,1.25,2.15,-.25,0,1,1,.25),wl(`T`,1.25,-2.475,2.55,13882323,1.25,.2,.1),wl(`U`,-1.375,2.15,2.25,0,.5,.5,.25),wl(`V`,-1.375,1.5,2,0,.5,.25,.5);var Tl={A:[`Q`],B:[`A`],C:[`B`,`J`],D:[`A`,`E`],E:[`Q`],F:[`E`,`R`],G:[`J`,`L`],H:[`A`,`E`,`L`,`S`],I:[`H`,`G`,`C`],J:[`K`],K:[],L:[`M`,`N`,`V`],M:[`U`],N:[`M`],O:[],P:[`L`,`R`],Q:[],R:[`L`],S:[],T:[],U:[],V:[`M`]};function El(e){[`C`,`G`,`I`,`J`,`K`,`M`,`N`,`T`].includes(e.userData.id)&&(e.position.z+=1),[`A`,`D`,`E`,`Q`,`R`].includes(e.userData.id)&&--e.position.z,[`D`,`H`,`I`,`L`,`M`,`S`,`U`,`V`].includes(e.userData.id)&&(e.position.y+=1),[`N`,`O`,`P`].includes(e.userData.id)&&--e.position.y,[`A`,`B`,`C`].includes(e.userData.id)&&(e.position.x+=1),[`E`,`F`,`G`,`R`].includes(e.userData.id)&&--e.position.x}var Dl=[],Ol=new ba,kl=new K,Al=null;window.addEventListener(`mousemove`,e=>{kl.x=e.clientX/window.innerWidth*2-1,kl.y=-(e.clientY/window.innerHeight)*2+1});function jl(){Ol.setFromCamera(kl,hl);let e=Ol.intersectObjects(xl);if(Al&&=(Al.material.emissive.set(0),null),e.length===0)return;let t=e[0].object;t.material.emissive.set(4473924),Al=t}window.addEventListener(`click`,e=>{kl.x=e.clientX/window.innerWidth*2-1,kl.y=-(e.clientY/window.innerHeight)*2+1,Ol.setFromCamera(kl,hl);let t=Ol.intersectObjects(xl);if(t.length===0)return;let n=t[0].object,r=n.userData.id,i=n.userData.displayName;Dl.includes(r)||(Tl[r].every(e=>Dl.includes(e))?(n.material.color.set(65280),Dl.push(r),Dl.length===xl.length&&(Nl(),Pl()),El(n),document.getElementById(`message`).innerText=`Correct: Removed ${i}`,document.getElementById(`noteBox`).innerText=Cl[r]):(n.material.color.set(16711680),Tl[r].filter(e=>Dl.includes(e)).length>0?document.getElementById(`message`).innerText=`${i} blocked. Remove ${Tl[r].filter(e=>!Dl.includes(e)).map(e=>Sl[e]).join(`, `)} first. 
        (Already removed ${Tl[r].filter(e=>Dl.includes(e)).map(e=>Sl[e]).join(`, `)})`:document.getElementById(`message`).innerText=`${i} blocked. Remove ${Tl[r].map(e=>Sl[e]).join(`, `)} first.`,setTimeout(()=>n.material.color.set(n.userData.defaultColor),1500)))});function Ml(){requestAnimationFrame(Ml),_l.update(),jl(),gl.render(ml,hl)}document.getElementById(`resetButton`).addEventListener(`click`,()=>{Dl.length=0,document.getElementById(`victoryMessage`).classList.remove(`show`),xl.forEach(e=>{e.material.color.set(e.userData.defaultColor),e.position.copy(e.userData.originalPosition)}),document.getElementById(`message`).innerText=`Select a cover`,document.getElementById(`noteBox`).innerText=`Extra considerations will appear here.`});function Nl(){document.getElementById(`victoryMessage`).classList.add(`show`)}function Pl(){let e=Date.now()+3e3,t=setInterval(()=>{if(Date.now()>e){clearInterval(t);return}pl({particleCount:20,spread:120,startVelocity:40,origin:{x:Math.random(),y:Math.random()*.5}})},200)}Ml();